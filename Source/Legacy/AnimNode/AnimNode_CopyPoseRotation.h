...
#include "AnimNode_CopyPoseRotation.generated.h"

class USkeletalMeshComponent;
struct FAnimInstanceProxy;

USTRUCT()
struct FBoneSourceToTargetMapping
{
	GENERATED_BODY()
...
struct LEGACY_API FAnimNode_CopyPoseRotation : public FAnimNode_Base
{
	...
	TArray<FBoneSourceToTargetMapping> BoneMapping;
...
private:
	...
	TMap<int32, FBoneSourceSettings> BoneMapToSourceSettings;
